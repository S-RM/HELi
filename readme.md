...
The only way of resolving this issue would be to create an offline mapping of different Event Log types and reconcile them against this before they are submitted to Elasticsearch. However, this may negatively impact performance.
