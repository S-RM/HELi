...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=cpu_count(),
        type=int,
        help="Enter the number of processes to run, e.g., --cores 8 or -c 8.  This defaults to your total core count"
    )
    parser.add_argument(
        "--buffer",
        "-b",
        default=1000,
        type=int,
        help="Enter the number of records to store in buffer before sending to elasticsearch: --buffer 1000 or -b 1000.  This defaults to 1000"
    )
    ...
    parser.add_argument(
        ...
        "-i",
        default='projectx',
        help="Enter the index name for elasticsearch: --index projectx or -i projectx. This defaults to projectx"
    )
    ...
    parser.add_argument(
        ...
        help="Enter the IP Address and Port for elasticsearch: --nodes 127.0.0.1:9200 or -n 127.0.0.1:9200. This can include multiple nodes using a comma ',' to seperate the nodes and wrapped in quotes e.g. '192.168.1.2:9200,192.168.1.3:9200'. This defaults to 127.0.0.1:9200"
    )
    ...
    parser.add_argument(
        ...
        "-t",
        default='',
        help="Enter credentials in the format: USERNAME:PASSWORD"
    )
